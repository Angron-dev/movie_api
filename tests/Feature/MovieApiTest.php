...
class MovieApiTest extends TestCase
{
    ...
    private function createMovie(float $popularity = 10.0): Movie
    {
        $movie = Movie::create([
    ...
    {
        $this->createMovie(20.0);
        $this->createMovie(10.0);
    ...
    {
        $response = $this->getJson('/api/movies?per_page=100');
    ...
    {
        $less = $this->createMovie(5.0);
        $more = $this->createMovie(50.0);
